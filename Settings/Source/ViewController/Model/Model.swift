...
extension Setting {
    static var settings: [[Setting]] = [
        ...
        [
            ...
            Setting(iconImage: UIImage(systemName: "speaker.fill"), text: "Звуки, тактильные сигналы", backgroundColor: .systemPink),
        ...
        [
            Setting(iconImage: UIImage(systemName: "gear"), text: "Основные", backgroundColor: .systemGray),
            Setting(iconImage: UIImage(systemName: "switch.2"), text: "Пункт управления", backgroundColor: .systemGray),
